  ...
  return (
    <div>
      <div className="card  gap-4 flex-col md:flex-row bg-white shadow-md p-8">
        <img src={product.product_image} alt="img" className="h-40 w-52 rounded-xl" />
        <div className="md:px-4 space-y-3 md:w-2/3">
          <h2 className="card-title font-semibold text-2xl text-primaryText">
            {product.product_title}
          </h2>
          <p className="text-lg text-primaryText/60"><span className='text-primaryText font-bold'>Description : </span> {product.description}</p>
